...
void Touchscreen_demo()
{
  ...
  if(ts_status == BSP_ERROR_NONE)
  {
	...
	UTIL_LCD_DisplayStringAt(0, 5, (uint8_t *)"TIC TAC TOE", CENTER_MODE);
	UTIL_LCD_SetFont(&Font12);
	UTIL_LCD_DisplayStringAt(0, 30, (uint8_t *)"Stefanija", CENTER_MODE);
	//UTIL_LCD_DisplayStringAt(0, 45, (uint8_t *)tempStr, CENTER_MODE);
